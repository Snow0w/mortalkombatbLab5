...
import edu.mephi.enemys.Baraka;
import edu.mephi.enemys.LiuKang;
import edu.mephi.enemys.ShaoKahn;
import edu.mephi.enemys.SonyaBlade;
import edu.mephi.enemys.SubZero;
...
public class CharacterAction {
  ...
  // private final int experience_for_next_level[] = {1000, 1000, 1000,
  //                                                  1000, 40,   1000};

  private final int kind_fight[][] = {
  ...
  public Player[] getEnemyes() { return this.enemyes; }

  public Player ChooseEnemy(JLabel label, JLabel label2, JLabel text,
                            JLabel label3) {
    ...
    label3.setText(Integer.toString(enemyy.getHealth()) + "/" +
                   Integer.toString(enemyy.getMaxHealth()));
    return enemyy;
  }
  ...
  public void UseItem(Player human, Items[] items, String name, JDialog dialog,
                      JDialog dialog1) {
    switch (name) {
    case "jRadioButton1":
